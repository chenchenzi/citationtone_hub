  ...
  <g clip-path="url(#htlWordclip)">
    <rect class="htl-glint" x="0" y="16" width="22" height="58"/>
                        ...
                        tags$p(style = "color: #555; font-size: 1.02rem; max-width: 820px; margin: 0 auto 14px auto; line-height: 1.55;",
                          "A free, end-to-end tool for citation tone research across tone languages. ",
                          "It integrates the full citation tone analysis workflow into one interactive app. ",
                              ...
                              tags$div(class = "showcase-row",
                                ...
                                tags$div(class = "showcase-cards-col",
                                  showcase_dots("analysis",
                                    c("visualise.png", "inspect.png", "cluster.png", "curate.png", "model.png", "summarise.png")),
                      ...
                      sidebarLayout(
                        sidebarPanel(
                          ...
                          conditionalPanel("input.tabs_data == 'Inspect'",
                                           uiOutput("ui_inspect")),
                          conditionalPanel("input.tabs_data == 'Cluster'",
                                           uiOutput("ui_cluster")),
                        ...
                        mainPanel(
                          tabsetPanel(id = "tabs_data",
                                      ...
                                      tabPanel("Cluster",
                                               uiOutput("cluster_guide"),
                                               uiOutput("cluster_discovery")),
                                      tabPanel("Curate",
