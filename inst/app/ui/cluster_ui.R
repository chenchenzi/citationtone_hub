  ...
  output$cluster_guide <- renderUI({
    guide_box("Tone clustering guide",
      tags$p(style = "margin: 4px 0 8px 0;", HTML(paste(
        ...
        "Cluster <strong>speaker-normalised</strong> f0 (semitone or z-score, from the Normalise tab):",
        "on raw Hz, clusters tend to separate <em>speakers</em> by pitch range rather than tones."))),
