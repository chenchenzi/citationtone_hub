...
output$instruction_text <- renderUI({
  tagList(
    ...
    tags$ul(
      ...
      tags$li(HTML("&#128203; "), tags$strong(style = "color: #78c2ad;", "Summarise"), " Convert tone contours into Chao tone numerals (1\u20135 scale). Compare three conversion methods side by side: reference-line FOR, interval-based FOR, and robust FOR.")
    )
  )
})
